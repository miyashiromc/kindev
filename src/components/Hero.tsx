...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-end md:justify-center pt-32 pb-20 md:py-32 px-6 overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10 max-w-4xl flex flex-col items-start md:items-center text-left md:text-center mt-auto md:mt-0">
