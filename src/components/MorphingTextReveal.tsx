...
export function MorphingTextReveal({
  ...
  return (
    <div className="relative inline-block cursor-pointer select-none" onMouseEnter={handleMouseEnter}>
      <span
        className={cn(
      ...
      <span
        className={cn(
          "inline-block w-0.5 h-[1em] bg-kindev-emerald ml-1 transition-opacity duration-500",
