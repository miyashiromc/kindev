...
export default function Pricing() {
  return (
    <section id="precios" className="relative flex flex-col items-center py-24 bg-white overflow-hidden">
      <div className="mb-16 md:text-center z-10 px-6">
      ...
      <div className="flex flex-col items-center justify-center gap-8 md:flex-row max-w-6xl mx-auto px-6 w-full">
        {/* Plataformas Card */}
        <motion.div
        ...
        >
          ...
          <p className="text-sm text-slate-500 mb-6">Sistemas a medida para tu negocio.</p>
        ...
        >
          ...
          <p className="text-sm text-slate-400 mb-6">Pago único. Ideal para presencia digital.</p>
        ...
        >
          ...
          <p className="text-sm text-slate-500 mb-6">Se cotiza según requerimientos.</p>
          <ul className="mb-8 space-y-3 text-[15px] font-normal text-slate-700">
