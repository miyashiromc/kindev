...
export default function ContactTerminal() {
  return (
    <section id="contacto" className="snap-start min-h-[100dvh] w-full flex flex-col items-center justify-center pt-24 pb-28 md:pt-20 md:pb-20 px-4 md:px-8 lg:px-12 bg-slate-900 relative overflow-hidden">
