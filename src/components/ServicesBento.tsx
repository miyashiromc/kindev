    ...
    >
      <div className="container mx-auto max-w-7xl relative z-10">
        <div className="mb-6 md:mb-8 md:text-center">
          <span className="section-label text-kindev-emerald/70 mb-4 block">Nuestros Servicios</span>
          <h2 className="text-3xl md:text-4xl font-display font-bold mb-3 gradient-text-primary">
        ...
        >
          ...
          <motion.div variants={item} className="md:col-span-2">
            <GlowCard className="p-6 md:p-8 hover:border-kindev-emerald/30 transition-colors h-full">
              ...
              <p className="text-slate-400 font-normal max-w-md text-[15px] md:text-[16px] leading-[1.5] text-left md:text-justify md:hyphens-auto">
              ...
              <div className="mt-6 flex flex-wrap gap-2">
                <span className="font-mono text-[11px] bg-white/[0.04] border border-white/[0.08] px-2.5 py-1 rounded text-slate-500">React / Next.js</span>
                <span className="font-mono text-[11px] bg-white/[0.04] border border-white/[0.08] px-2.5 py-1 rounded text-slate-500">Tailwind CSS</span>
                <span className="font-mono text-[11px] bg-white/[0.04] border border-white/[0.08] px-2.5 py-1 rounded text-slate-500">SEO</span>
              </div>
            </GlowCard>
          </motion.div>
          ...
          <motion.div variants={item}>
            <GlowCard className="p-6 md:p-8 hover:border-kindev-cyan/30 transition-colors h-full">
              ...
              <p className="text-slate-400 font-normal text-[14px] md:text-[15px] leading-[1.5] text-left md:text-justify md:hyphens-auto">
          ...
          {/* Bottom left block */}
          <motion.div variants={item}>
            <GlowCard className="p-6 md:p-8 hover:border-kindev-purple/30 transition-colors h-full">
          ...
          <motion.div variants={item} className="md:col-span-2 group relative p-6 md:p-8 rounded-3xl glass-dark text-white overflow-hidden shadow-xl hover:shadow-2xl transition-all border hover:border-white/20">
            ...
            <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-4 md:gap-6">
              <div className="max-w-sm">
                ...
                <p className="text-slate-300 font-normal text-[14px] md:text-[15px] leading-[1.5] text-left md:text-justify md:hyphens-auto">
