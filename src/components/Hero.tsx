...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-end md:justify-center pt-28 pb-16 md:py-32 px-4 md:px-8 overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10 max-w-5xl flex flex-col items-start md:items-center text-left md:text-center mt-auto md:mt-0">
